...
9. [ Advanced Configuration (2.0.9) ](#advanced)
...
### Cocoapods
*Demo pod version: SMKitUI '2.0.9'*

This native demo is pinned to SMKitUI 2.0.9 and exposes the relevant SDK controls through the in-app Settings screen.
...
Latest demo-aligned version: smkit_ui_package '2.0.9'
...
## 9. Advanced Configuration (2.0.9) <a name="advanced"></a>
